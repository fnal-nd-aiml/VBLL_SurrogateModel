...
CFG = {
    ...
    'checkpoint_path':  '../output_data/checkpoints/best_model_x60_std.pt', #large dataset
    'figures_dir':      '../output_data/figures/figures_x60_std', #large dataset
}

# Optional CLI override:
#   python run.py path/to/file.csv
#   python run.py path/to/folder_of_csv_chunks
if len(sys.argv) > 1:
    CFG['data_path'] = sys.argv[1]

print(f"[run] data_path = {CFG['data_path']}")
